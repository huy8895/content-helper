...
window.GoogleAIStudioSpeechView = {
  ...
  <!-- Form Cài Đặt -->
  <div id="profile-settings-form" class="ts-flex ts-flex-col ts-gap-2" style="margin-bottom: 12px;">
    ...
    <div>
      ...
      <textarea id="scene-instructions" class="ts-textarea" style="height: 52px;" placeholder="Nhập bối cảnh (Scene)..."></textarea>
    </div>

    <div>
      <label for="style-instructions" class="ts-label">Style instructions (Sample Context)</label>
      <textarea id="style-instructions" class="ts-textarea" style="height: 70px;" placeholder="Nhập hướng dẫn phong cách..."></textarea>
    </div>
